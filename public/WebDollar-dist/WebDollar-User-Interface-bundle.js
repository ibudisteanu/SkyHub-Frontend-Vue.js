...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Address_Address_vue__ = __webpack_require__(16);
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6fd10b33_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Address_vue__ = __webpack_require__(94);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Modals_Delete_modal_vue__ = __webpack_require__(90);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_v_clipboard__ = __webpack_require__(8);
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3b585992_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Lock_modal_vue__ = __webpack_require__(89);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_dc2c73dc_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Delete_modal_vue__ = __webpack_require__(93);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
// module
exports.push([module.i, "\n.descriptionText{\n\n    color: #bdbdbd;\n    padding: 30px 10px;\n}\n.inputDeleteModal{\n    width: 90%;\n    background-color: #2d2d2d;\n    border: solid 1px #565656;\n    margin: 0 auto;\n    left: 0;\n    right: 0;\n    color: #ccc;\n    padding: 7px;\n    font-weight: 100;\n    text-align: center;\n    font-size: 14px;\n    margin-bottom: 20px;\n}\n.modalButton{\n    background-color: #131313;\n    color: #969696;\n    font-size: 12px;\n    width: 140px;\n    border: solid 1px #5f5d5d;\n    font-weight: bolder;\n    border-radius: 5px;\n    letter-spacing: 2px;\n    text-transform: uppercase;\n    padding: 8px;\n    margin: 0 auto;\n    margin-bottom: 20px;\n    transition: all .3s linear;\n}\n.modalButton:hover{\n    background-color: #f6ba2c;\n    color: #000000;\n    transition: all .3s linear;\n}\n.coloredText{\n    color: #f6ba2c;\n}\n\n", "", {"version":3,"sources":["/Users/alexandru.panait/Work/Other/User-Interface-WebDollar/src/components/Wallet/Address/Modals/src/components/Wallet/Address/Modals/Delete.modal.vue"],"names":[],"mappings":";AAyGA;;IAEA,eAAA;IACA,mBAAA;CAEA;AAEA;IACA,WAAA;IACA,0BAAA;IACA,0BAAA;IACA,eAAA;IACA,QAAA;IACA,SAAA;IACA,YAAA;IACA,aAAA;IACA,iBAAA;IACA,mBAAA;IACA,gBAAA;IACA,oBAAA;CACA;AAEA;IACA,0BAAA;IACA,eAAA;IACA,gBAAA;IACA,aAAA;IACA,0BAAA;IACA,oBAAA;IACA,mBAAA;IACA,oBAAA;IACA,0BAAA;IACA,aAAA;IACA,eAAA;IACA,oBAAA;IACA,2BAAA;CACA;AAEA;IACA,0BAAA;IACA,eAAA;IACA,2BAAA;CACA;AAEA;IACA,eAAA;CACA","file":"Delete.modal.vue","sourcesContent":["<template>\n\n    <div>\n\n        <Modal title=\"Delete Address\" ref=\"refModal\">\n\n            <div slot=\"content\">\n\n                <div class=\"descriptionText\">\n\n                    For Delete this Address Type <span class=\"coloredText\">DELETE</span>\n\n                </div>\n\n                <div >\n\n                    <input v-model=\"inputValue\" class=\"inputDeleteModal\"/>\n\n                    <div @click=\"this.deleteAddress\" class=\"modalButton\">\n                        Delete\n                    </div>\n\n                </div>\n\n            </div>\n\n        </Modal>\n\n    </div>\n\n</template>\n\n<script>\n\n    let Vue = require('vue/dist/vue.min.js');\n    import Modal from \"components/UI/modal/Modal.vue\"\n\n    import Clipboard from './../../../../../node_modules/v-clipboard'\n\n    Vue.use(Clipboard);\n\n    export default {\n\n        props: {\n            address: {default: null},\n            toAddress: {default: null},\n            toAmount: {default: 0.0},\n\n        },\n\n        components: {\n            \"Modal\":Modal,\n        },\n\n        data: () => {\n            return {\n                inputValue: ''\n            }\n        },\n\n        methods: {\n\n            async deleteAddress(){\n\n                if (this.inputValue.toUpperCase().trim().toUpperCase() === 'DELETE'){\n\n                    // WebDollar.Blockchain.wallet. - DELETE\n                    let answer = await WebDollar.Blockchain.Wallet.deleteAddress(this.address);\n\n                    console.log(answer);\n                }\n\n                this.closeModal();\n\n            },\n\n            closeModal(e) {\n                this.inputValue = \"\";\n                if (this.$refs['refModal'] !== undefined)\n                    this.$refs['refModal'].closeModal(e);\n            },\n\n            showModal(e) {\n\n                if (this.$refs['refModal'].modalOpened === false){\n                    console.log(\"shooow modal\");\n                    this.$refs['refModal'].showModal(e);\n                }\n\n            }\n\n        },\n\n        mounted() {\n\n            if (typeof window === 'undefined') return;\n\n        },\n\n    }\n\n</script>\n\n<style>\n\n    .descriptionText{\n\n        color: #bdbdbd;\n        padding: 30px 10px;\n\n    }\n\n    .inputDeleteModal{\n        width: 90%;\n        background-color: #2d2d2d;\n        border: solid 1px #565656;\n        margin: 0 auto;\n        left: 0;\n        right: 0;\n        color: #ccc;\n        padding: 7px;\n        font-weight: 100;\n        text-align: center;\n        font-size: 14px;\n        margin-bottom: 20px;\n    }\n\n    .modalButton{\n        background-color: #131313;\n        color: #969696;\n        font-size: 12px;\n        width: 140px;\n        border: solid 1px #5f5d5d;\n        font-weight: bolder;\n        border-radius: 5px;\n        letter-spacing: 2px;\n        text-transform: uppercase;\n        padding: 8px;\n        margin: 0 auto;\n        margin-bottom: 20px;\n        transition: all .3s linear;\n    }\n\n    .modalButton:hover{\n        background-color: #f6ba2c;\n        color: #000000;\n        transition: all .3s linear;\n    }\n\n    .coloredText{\n        color: #f6ba2c;\n    }\n\n</style>\n\n"],"sourceRoot":""}]);
