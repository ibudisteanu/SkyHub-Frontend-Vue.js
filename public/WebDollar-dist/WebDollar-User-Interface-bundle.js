...
// devtools global hook
    ...
    __vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{ref:"dashboardWallet",staticClass:"dashboardWallet"},[_c('div',{ref:"walletMenuButton",style:({
        ...
        borderTopLeftRadius: this.opened ? this.walletButtonRadiusLeftClose+'px' : this.walletButtonRadiusLeftOpen+'px',
        borderTopRightRadius: this.opened ? this.walletButtonRadiusRightClose+'px' : this.walletButtonRadiusRightOpen+'px'}),attrs:{"id":"walletButton"},on:{"click":this.toggleWallet}},[_c('span',{attrs:{"id":"walletButtonText"}},[_c('icon',{staticClass:"buttonIcon",attrs:{"icon":this.opened ? 'chevron-down' : 'chevron-up'}}),_vm._v("\n            Wallet\n            "),_c('ShowSumBalances',{ref:"showSumBalances",attrs:{"addresses":this.addresses,"currency":this.currency}})],1)]),_vm._v(" "),_c('div',{ref:"walletMenu",style:({
