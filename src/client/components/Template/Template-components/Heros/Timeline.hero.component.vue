...
<template>
    ...
    <SimpleHero url="/" coverColor="white">
        ...
        <div slot="hero-content" style="text-align: center">
            ...
            <h1 class='fg-white' style="margin-top:-10px; display: inline; font-size: 40px; font-weight: bold; text-transform: none; color: #12428c; text-align: center; margin-bottom: 10px; padding-left: 0.5em; padding-right: 0.5em; ">Timeline</h1> <br/> <br/>
